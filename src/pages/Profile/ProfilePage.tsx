...
const ProfilePage = () => {
  ...
  return (
    <div className="x py-[200px] flex items-center flex-col px-11 gap-11 justify-center">
      <div className=" rounded-2xl border-4 border-slate-500 flex flex-row gap-4 w-full sm:w-[700px] shadow-lg">
        <div className="flex items-center flex-col p-3">
          ...
          <button
           ...
           className="py-2 px-4 bg-red-800 rounded-xl text-white">Log Out</button>
        </div>
