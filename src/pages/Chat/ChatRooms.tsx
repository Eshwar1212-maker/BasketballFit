...
export const ChatRooms = () => {
  ...
  return (
    <div className="flex justify-center py-[75px] m-auto h-[100vh] text-white">
   {room ? <><ChatGroup room={room}/></> :<div className=" w-[800px] bg-cover border-black bg-center bg-no-repeat rounded-2xl border-4 border-r-4 bg-[url('https://hoopshype.com/wp-content/uploads/sites/92/2019/08/anthonydavis_phone2.jpg')]">
