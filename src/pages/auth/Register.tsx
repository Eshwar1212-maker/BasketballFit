  ...
  return (
    <div className=" text-white relative h-screen my-[30px]">
      <video
        ...
        muted
      />
      <div className="bg-blue-50 flex items-center flex-col md:py-[30px] absolute w-full h-full top-0 left-0 bg-gray-900/30 text-center cursor-pointer">
        <span className="text-xl font-bold block mb-4">
          Create an account!
        </span>

        <form onSubmit={handleSubmit} className="border-2 p-3 rounded-lg bg-white">
